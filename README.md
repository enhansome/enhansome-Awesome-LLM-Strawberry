...
* \[Alibaba Qwen Team] [Qwen3](https://github.com/QwenLM/Qwen3) ⭐ 27,547 | 🐛 64 | 🌐 Python | 📅 2026-01-09
...
* \[OpenRLHF Team] [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,943 | 🐛 361 | 🌐 Python | 📅 2026-08-13
...
* \[Alibaba] [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,368 | 🐛 126 | 🌐 Python | 📅 2026-08-22 | [Paper](https://arxiv.org/abs/2506.06122)
...
* \[NovaSky-AI] [SkyRL](https://github.com/NovaSky-AI/SkyRL) ⭐ 2,186 | 🐛 434 | 🌐 Python | 📅 2026-08-22
...
* [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf) ⭐ 92,036 | 🐛 35 | 📅 2025-06-27
  * DeepSeek AI
* [Qwen3 Technical Report ](https://github.com/QwenLM/Qwen3/blob/main/Qwen3_Technical_Report.pdf) ⭐ 27,547 | 🐛 64 | 🌐 Python | 📅 2026-01-09
  * Qwen Team
...
* [REINFORCE++: An Efficient RLHF Algorithm with Robustness to Both Prompt and Reward Models](https://www.researchgate.net/publication/387487679_REINFORCE_An_Efficient_RLHF_Algorithm_with_Robustnessto_Both_Prompt_and_Reward_Models)
  * Code: [REINFORCE++-baseline](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_llama_ray_hybrid_engine.sh) ⭐ 9,943 | 🐛 361 | 🌐 Python | 📅 2026-08-13
