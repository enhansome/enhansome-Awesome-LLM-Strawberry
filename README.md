...
* \[Alibaba Qwen Team] [Qwen3](https://github.com/QwenLM/Qwen3) ⭐ 27,657 | 🐛 68 | 🌐 Python | 📅 2026-01-09
...
* \[Alibaba] [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,407 | 🐛 134 | 🌐 Python | 📅 2026-09-25 | [Paper](https://arxiv.org/abs/2506.06122)
...
* \[NovaSky-AI] [SkyRL](https://github.com/NovaSky-AI/SkyRL) ⭐ 2,349 | 🐛 488 | 🌐 Python | 📅 2026-09-25
...
* [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf) ⭐ 91,968 | 🐛 39 | 📅 2025-06-27
  * DeepSeek AI
* [Qwen3 Technical Report ](https://github.com/QwenLM/Qwen3/blob/main/Qwen3_Technical_Report.pdf) ⭐ 27,657 | 🐛 68 | 🌐 Python | 📅 2026-01-09
  * Qwen Team
...
* [Kimi k1.5: Scaling Reinforcement Learning with LLMs](https://github.com/MoonshotAI/Kimi-k1.5) ⭐ 3,467 | 🐛 16 | 📅 2025-03-07
  * MoonShot
* [MiMo-V2 Flash](https://github.com/XiaomiMiMo/MiMo-V2-Flash/blob/main/paper.pdf) ⭐ 1,384 | 🐛 22 | 📅 2026-01-08
  * Xiao Mi
...
* [REINFORCE++: An Efficient RLHF Algorithm with Robustness to Both Prompt and Reward Models](https://www.researchgate.net/publication/387487679_REINFORCE_An_Efficient_RLHF_Algorithm_with_Robustnessto_Both_Prompt_and_Reward_Models)
  * Code: [REINFORCE++-baseline](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_llama_ray_hybrid_engine.sh) ⭐ 10,044 | 🐛 388 | 🌐 Python | 📅 2026-09-17
