...
* \[Alibaba Qwen Team] [Qwen3](https://github.com/QwenLM/Qwen3) ⭐ 27,555 | 🐛 65 | 🌐 Python | 📅 2026-01-09
...
* \[CUHK-SZ] [HuatuoGPT-o1](https://github.com/FreedomIntelligence/HuatuoGPT-o1) ⭐ 1,349 | 🐛 27 | 🌐 Python | 📅 2025-01-20
...
* \[Berkeley AI Research] [TinyZero](https://github.com/Jiayi-Pan/TinyZero) ⭐ 13,222 | 🐛 82 | 🌐 Python | 📅 2026-02-27
* \[OpenRLHF Team] [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,953 | 🐛 361 | 🌐 Python | 📅 2026-08-13
...
* \[LLaMA-Factory Team] [EasyR1: An Efficient, Scalable, Multi-Modality RL Training Framework](https://github.com/hiyouga/EasyR1) ⭐ 5,128 | 🐛 56 | 🌐 Python | 📅 2026-07-30
...
* \[Alibaba] [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,373 | 🐛 126 | 🌐 Python | 📅 2026-08-25 | [Paper](https://arxiv.org/abs/2506.06122)
...
* \[Maitrix.org] [LLM Reasoners](https://github.com/maitrix-org/llm-reasoners) ⭐ 2,342 | 🐛 32 | 🌐 Python | 📅 2025-06-10
* \[NovaSky-AI] [SkyRL](https://github.com/NovaSky-AI/SkyRL) ⭐ 2,195 | 🐛 436 | 🌐 Python | 📅 2026-08-24
...
* [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf) ⭐ 92,043 | 🐛 35 | 📅 2025-06-27
  * DeepSeek AI
* [Qwen3 Technical Report ](https://github.com/QwenLM/Qwen3/blob/main/Qwen3_Technical_Report.pdf) ⭐ 27,555 | 🐛 65 | 🌐 Python | 📅 2026-01-09
  * Qwen Team
* [Kimi k2: Open agentic intelligence](https://github.com/MoonshotAI/Kimi-K2/blob/main/tech_report.pdf) ⭐ 11,106 | 🐛 70 | 📅 2026-01-21
  * MoonShot
...
* [MiMo-V2 Flash](https://github.com/XiaomiMiMo/MiMo-V2-Flash/blob/main/paper.pdf) ⭐ 1,367 | 🐛 22 | 📅 2026-01-08
  * Xiao Mi
* [LongCat Flash](https://github.com/meituan-longcat/LongCat-Flash-Chat/blob/main/tech_report.pdf) ⭐ 1,364 | 🐛 15 | 📅 2026-06-23
  * Meituan
* [DeepSeek-Prover-V2: Advancing Formal Mathematical Reasoning via Reinforcement Learning for Subgoal Decomposition](https://github.com/deepseek-ai/DeepSeek-Prover-V2/tree/main) ⭐ 1,297 | 🐛 12 | 📅 2025-07-18
  * DeepSeek AI
* [KIMI-VL TECHNICAL REPORT](https://github.com/MoonshotAI/Kimi-VL/blob/main/Kimi-VL.pdf) ⭐ 1,223 | 🐛 40 | 📅 2025-07-15
  * MoonShot
* [Seed Thinking v1.5](https://github.com/ByteDance-Seed/Seed-Thinking-v1.5) ⭐ 810 | 🐛 10 | 📅 2025-06-09
  * Bytedance Seed
* [Kimina-Prover Preview: Towards Large Formal Reasoning Models with Reinforcement Learning](https://github.com/MoonshotAI/Kimina-Prover-Preview) ⭐ 375 | 🐛 1 | 🌐 Python | 📅 2025-07-10
  * MoonShot & Numina
...
* [REINFORCE++: An Efficient RLHF Algorithm with Robustness to Both Prompt and Reward Models](https://www.researchgate.net/publication/387487679_REINFORCE_An_Efficient_RLHF_Algorithm_with_Robustnessto_Both_Prompt_and_Reward_Models)
  * Code: [REINFORCE++-baseline](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_llama_ray_hybrid_engine.sh) ⭐ 9,953 | 🐛 361 | 🌐 Python | 📅 2026-08-13
