...
* \[Alibaba Qwen Team] [Qwen3](https://github.com/QwenLM/Qwen3) ⭐ 27,561 | 🐛 65 | 🌐 Python | 📅 2026-01-09
...
* \[LLaMA-Factory Team] [EasyR1: An Efficient, Scalable, Multi-Modality RL Training Framework](https://github.com/hiyouga/EasyR1) ⭐ 5,129 | 🐛 56 | 🌐 Python | 📅 2026-08-26
...
* \[Alibaba] [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,374 | 🐛 127 | 🌐 Python | 📅 2026-08-26 | [Paper](https://arxiv.org/abs/2506.06122)
...
* \[NovaSky-AI] [SkyRL](https://github.com/NovaSky-AI/SkyRL) ⭐ 2,201 | 🐛 435 | 🌐 Python | 📅 2026-08-24
...
* [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf) ⭐ 92,038 | 🐛 35 | 📅 2025-06-27
  * DeepSeek AI
* [Qwen3 Technical Report ](https://github.com/QwenLM/Qwen3/blob/main/Qwen3_Technical_Report.pdf) ⭐ 27,561 | 🐛 65 | 🌐 Python | 📅 2026-01-09
  * Qwen Team
...
* [DeepSeek-Prover-V2: Advancing Formal Mathematical Reasoning via Reinforcement Learning for Subgoal Decomposition](https://github.com/deepseek-ai/DeepSeek-Prover-V2/tree/main) ⭐ 1,297 | 🐛 12 | 📅 2025-07-18
  * DeepSeek AI
* [KIMI-VL TECHNICAL REPORT](https://github.com/MoonshotAI/Kimi-VL/blob/main/Kimi-VL.pdf) ⭐ 1,224 | 🐛 40 | 📅 2025-07-15
  * MoonShot
