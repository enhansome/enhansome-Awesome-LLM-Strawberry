...
* \[Alibaba Qwen Team] [Qwen3](https://github.com/QwenLM/Qwen3) ⭐ 27,609 | 🐛 67 | 🌐 Python | 📅 2026-01-09
* \[NovaSky] [Sky-T1](https://github.com/NovaSky-AI/SkyThought) ⭐ 3,400 | 🐛 22 | 🌐 Python | 📅 2025-07-12
...
* \[CUHK-SZ] [HuatuoGPT-o1](https://github.com/FreedomIntelligence/HuatuoGPT-o1) ⭐ 1,357 | 🐛 27 | 🌐 Python | 📅 2025-01-20
* \[rLLM] [DeepScaler](https://github.com/agentica-project/rllm) ⭐ 412 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2025-09-17
...
* \[Berkeley AI Research] [TinyZero](https://github.com/Jiayi-Pan/TinyZero) ⭐ 13,236 | 🐛 82 | 🌐 Python | 📅 2026-02-27
* \[OpenRLHF Team] [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 9,997 | 🐛 364 | 🌐 Python | 📅 2026-09-12
* \[OpenRLHF Team] [REINFORCE++ | REINFORCE++-baseline](https://www.researchgate.net/publication/387487679_REINFORCE_An_Efficient_RLHF_Algorithm_with_Robustnessto_Both_Prompt_and_Reward_Models) | [Code](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_llama_ray_hybrid_engine.sh) ⭐ 9,997 | 🐛 364 | 🌐 Python | 📅 2026-09-12
* \[LLaMA-Factory Team] [EasyR1: An Efficient, Scalable, Multi-Modality RL Training Framework](https://github.com/hiyouga/EasyR1) ⭐ 5,157 | 🐛 57 | 🌐 Python | 📅 2026-08-31
* \[R1-V Team] [R1-V](https://github.com/Deep-Agent/R1-V) ⭐ 4,061 | 🐛 95 | 🌐 Python | 📅 2025-05-19
...
* \[Alibaba] [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,394 | 🐛 130 | 🌐 Python | 📅 2026-09-12 | [Paper](https://arxiv.org/abs/2506.06122)
...
* \[Maitrix.org] [LLM Reasoners](https://github.com/maitrix-org/llm-reasoners) ⭐ 2,346 | 🐛 32 | 🌐 Python | 📅 2025-06-10
* \[NovaSky-AI] [SkyRL](https://github.com/NovaSky-AI/SkyRL) ⭐ 2,295 | 🐛 456 | 🌐 Python | 📅 2026-09-12
...
* [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf) ⭐ 91,994 | 🐛 33 | 📅 2025-06-27
  * DeepSeek AI
* [Qwen3 Technical Report ](https://github.com/QwenLM/Qwen3/blob/main/Qwen3_Technical_Report.pdf) ⭐ 27,609 | 🐛 67 | 🌐 Python | 📅 2026-01-09
  * Qwen Team
* [Kimi k2: Open agentic intelligence](https://github.com/MoonshotAI/Kimi-K2/blob/main/tech_report.pdf) ⭐ 11,114 | 🐛 71 | 📅 2026-01-21
  * MoonShot
...
* [MiMo-V2 Flash](https://github.com/XiaomiMiMo/MiMo-V2-Flash/blob/main/paper.pdf) ⭐ 1,369 | 🐛 22 | 📅 2026-01-08
  * Xiao Mi
* [LongCat Flash](https://github.com/meituan-longcat/LongCat-Flash-Chat/blob/main/tech_report.pdf) ⭐ 1,366 | 🐛 14 | 📅 2026-06-23
  * Meituan
* [DeepSeek-Prover-V2: Advancing Formal Mathematical Reasoning via Reinforcement Learning for Subgoal Decomposition](https://github.com/deepseek-ai/DeepSeek-Prover-V2/tree/main) ⭐ 1,303 | 🐛 12 | 📅 2025-07-18
  * DeepSeek AI
* [KIMI-VL TECHNICAL REPORT](https://github.com/MoonshotAI/Kimi-VL/blob/main/Kimi-VL.pdf) ⭐ 1,227 | 🐛 40 | 📅 2025-07-15
  * MoonShot
...
* [REINFORCE++: An Efficient RLHF Algorithm with Robustness to Both Prompt and Reward Models](https://www.researchgate.net/publication/387487679_REINFORCE_An_Efficient_RLHF_Algorithm_with_Robustnessto_Both_Prompt_and_Reward_Models)
  * Code: [REINFORCE++-baseline](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_llama_ray_hybrid_engine.sh) ⭐ 9,997 | 🐛 364 | 🌐 Python | 📅 2026-09-12
