...
* \[Alibaba Qwen Team] [Qwen3](https://github.com/QwenLM/Qwen3) ⭐ 27,615 | 🐛 67 | 🌐 Python | 📅 2026-01-09
...
* \[Alibaba] [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,395 | 🐛 131 | 🌐 Python | 📅 2026-09-14 | [Paper](https://arxiv.org/abs/2506.06122)
...
* \[NovaSky-AI] [SkyRL](https://github.com/NovaSky-AI/SkyRL) ⭐ 2,300 | 🐛 458 | 🌐 Python | 📅 2026-09-14
...
* [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf) ⭐ 91,990 | 🐛 33 | 📅 2025-06-27
  * DeepSeek AI
* [Qwen3 Technical Report ](https://github.com/QwenLM/Qwen3/blob/main/Qwen3_Technical_Report.pdf) ⭐ 27,615 | 🐛 67 | 🌐 Python | 📅 2026-01-09
  * Qwen Team
...
* [REINFORCE++: An Efficient RLHF Algorithm with Robustness to Both Prompt and Reward Models](https://www.researchgate.net/publication/387487679_REINFORCE_An_Efficient_RLHF_Algorithm_with_Robustnessto_Both_Prompt_and_Reward_Models)
  * Code: [REINFORCE++-baseline](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_llama_ray_hybrid_engine.sh) ⭐ 10,006 | 🐛 376 | 🌐 Python | 📅 2026-09-14
