...
* \[Alibaba Qwen Team] [Qwen3](https://github.com/QwenLM/Qwen3) ⭐ 27,646 | 🐛 68 | 🌐 Python | 📅 2026-01-09
...
* \[Berkeley AI Research] [TinyZero](https://github.com/Jiayi-Pan/TinyZero) ⭐ 13,238 | 🐛 82 | 🌐 Python | 📅 2026-02-27
* \[OpenRLHF Team] [OpenRLHF](https://github.com/OpenRLHF/OpenRLHF) ⭐ 10,020 | 🐛 384 | 🌐 Python | 📅 2026-09-17
* \[OpenRLHF Team] [REINFORCE++ | REINFORCE++-baseline](https://www.researchgate.net/publication/387487679_REINFORCE_An_Efficient_RLHF_Algorithm_with_Robustnessto_Both_Prompt_and_Reward_Models) | [Code](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_llama_ray_hybrid_engine.sh) ⭐ 10,020 | 🐛 384 | 🌐 Python | 📅 2026-09-17
* \[LLaMA-Factory Team] [EasyR1: An Efficient, Scalable, Multi-Modality RL Training Framework](https://github.com/hiyouga/EasyR1) ⭐ 5,166 | 🐛 57 | 🌐 Python | 📅 2026-09-19
...
* \[Alibaba] [ROLL](https://github.com/alibaba/ROLL) ⭐ 3,401 | 🐛 133 | 🌐 Python | 📅 2026-09-20 | [Paper](https://arxiv.org/abs/2506.06122)
...
* \[NovaSky-AI] [SkyRL](https://github.com/NovaSky-AI/SkyRL) ⭐ 2,334 | 🐛 485 | 🌐 Python | 📅 2026-09-19
...
* [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://github.com/deepseek-ai/DeepSeek-R1/blob/main/DeepSeek_R1.pdf) ⭐ 91,983 | 🐛 35 | 📅 2025-06-27
  * DeepSeek AI
* [Qwen3 Technical Report ](https://github.com/QwenLM/Qwen3/blob/main/Qwen3_Technical_Report.pdf) ⭐ 27,646 | 🐛 68 | 🌐 Python | 📅 2026-01-09
  * Qwen Team
* [Kimi k2: Open agentic intelligence](https://github.com/MoonshotAI/Kimi-K2/blob/main/tech_report.pdf) ⭐ 11,117 | 🐛 72 | 📅 2026-01-21
  * MoonShot
* [Kimi k1.5: Scaling Reinforcement Learning with LLMs](https://github.com/MoonshotAI/Kimi-k1.5) ⭐ 3,466 | 🐛 16 | 📅 2025-03-07
  * MoonShot
* [MiMo-V2 Flash](https://github.com/XiaomiMiMo/MiMo-V2-Flash/blob/main/paper.pdf) ⭐ 1,368 | 🐛 22 | 📅 2026-01-08
  * Xiao Mi
* [LongCat Flash](https://github.com/meituan-longcat/LongCat-Flash-Chat/blob/main/tech_report.pdf) ⭐ 1,368 | 🐛 15 | 📅 2026-06-23
  * Meituan
...
* [REINFORCE++: An Efficient RLHF Algorithm with Robustness to Both Prompt and Reward Models](https://www.researchgate.net/publication/387487679_REINFORCE_An_Efficient_RLHF_Algorithm_with_Robustnessto_Both_Prompt_and_Reward_Models)
  * Code: [REINFORCE++-baseline](https://github.com/OpenRLHF/OpenRLHF/blob/main/examples/scripts/train_reinforce_baseline_llama_ray_hybrid_engine.sh) ⭐ 10,020 | 🐛 384 | 🌐 Python | 📅 2026-09-17
